...
describe('Collapse.vue', () => {
  ...
  test('手风琴模式下同时只能打开一个面板', async () => {
    ...
    const headers = accordionWrapper.findAll('.vk-collapse-item__header')
    const contents = accordionWrapper.findAll('.vk-collapse-item__wrapper')
    ...
    expect(contents[2].isVisible()).toBeTruthy()
  })
})
